...
**Repository**: https://github.com/helloJamest/FinAgent/issues
...
```bash
gh issue view <issue_number> --repo helloJamest/FinAgent
gh issue view <issue_number> --repo helloJamest/FinAgent --comments
```
