...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "AGENT_ARCH": {
        ...
        "description": "Agent execution architecture. 'single' uses the classic ReAct executor; 'multi' uses the internal orchestrator; 'debate' uses the CAMEL-backed debate pipeline.",
        "category": "agent",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
        ...
        "options": [
            ...
            {"label": "Debate Agent (CAMEL)", "value": "debate"},
        ],
        "validation": {"enum": ["single", "multi", "debate"]},
        "display_order": 60,
    },
    "DEBATE_BACKEND": {
        "title": "Debate Backend",
        "description": "Backend used when AGENT_ARCH=debate. CAMEL is the primary backend; internal preserves the original DebateArena implementation.",
        "category": "agent",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
        ...
        "options": [
            ...
            {"label": "Internal fallback", "value": "internal"},
        ],
        "validation": {"enum": ["camel", "internal"]},
        "display_order": 64,
    },
    "DEBATE_FALLBACK_BACKEND": {
        "title": "Debate Fallback Backend",
        "description": "Backend used when CAMEL initialization or execution fails.",
        "category": "agent",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
        ...
        "validation": {"enum": ["internal"]},
        "display_order": 65,
    },
    "CAMEL_MODEL_PLATFORM": {
        "title": "CAMEL Model Platform",
        "description": "CAMEL model platform. The first integration supports OpenAI-compatible endpoints.",
        "category": "agent",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        ...
        "options": [],
        "validation": {"enum": ["openai_compatible"]},
        "display_order": 66,
    },
    "CAMEL_MODEL_NAME": {
        "title": "CAMEL Model Name",
        "description": "Model name passed to the OpenAI-compatible CAMEL backend.",
        "category": "agent",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "CAMEL_BASE_URL": {
        "title": "CAMEL Base URL",
        "description": "OpenAI-compatible API base URL used by CAMEL.",
        "category": "agent",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "CAMEL_API_KEY": {
        "title": "CAMEL API Key",
        "description": "API key for the CAMEL OpenAI-compatible endpoint.",
        "category": "agent",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "CAMEL_TEMPERATURE": {
        "title": "CAMEL Temperature",
        "description": "CAMEL model sampling temperature.",
        "category": "agent",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "CAMEL_MAX_TOKENS": {
        "title": "CAMEL Max Tokens",
        "description": "Maximum completion tokens for each CAMEL role call.",
        "category": "agent",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
