...
- GitHub Issues: [Report bugs or request features](https://github.com/helloJamest/FinAgent/issues)
- Discussions: [Join discussions](https://github.com/helloJamest/FinAgent/discussions)
