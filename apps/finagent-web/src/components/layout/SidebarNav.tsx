...
import { BarChart3, BriefcaseBusiness, Filter, Home, LogOut, MessageSquareQuote, Settings2 } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'screener', label: '选股', to: '/screener', icon: Filter },
...
export const SidebarNav: React.FC<SidebarNavProps> = ({ collapsed = false, onNavigate }) => {
  ...
  return (
    <div className="flex h-full w-full flex-col overflow-hidden">
      <div className={cn('mb-3 flex shrink-0 items-center gap-2 px-1 pt-1', collapsed ? 'justify-center' : '')}>
        ...
        {!collapsed ? (
          <p className="min-w-0 truncate text-sm font-semibold text-foreground">FinAgent</p>
        ) : null}
      </div>
